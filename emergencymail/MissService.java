...
public class MissService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
    	...
    	Date d = new Date();
         ...
         if((frt<=crt)&&(crt<=tot))
              {
        	 GMailSender sender = new GMailSender("manojareddy000@gmail.com", "ems@4441");
	        try {
	        	
	        	
	        	System.out.println("$$#$%^ in try %^&**");
				sender.sendMail(" Ping Me - Notification. ",   
				        "Hi Greeting from Emergency  Team,"+"\n"+
				"You got a call from: " +"\n"+num  
				        +"\n" 
				        		+"\n" +"Thanks,"+ "\n"+
				        		"--Emergency Team."+ "\n"+
				        		"Visit us: facebook.com/Emergency"+ "\n"+
				        		"Our Other Apps: https://play.google.com/store/search?q=%22COIGN%22"+ "\n"+
				        		"Contact: + (INDIA)",   
				        "Emergency@gmail.com",   
				        emailid);
			} catch (Exception e) {
